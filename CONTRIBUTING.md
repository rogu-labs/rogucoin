Contributing to Rogucoin Core
============================

The Rogucoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/rogu-labs/rogucoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Rogucoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Rogucoin
Network Protocol consensus changes.

Whether a pull request is merged into Rogucoin Core rests with the project merge
...
Patches that change Rogucoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Rogucoin consensus, it must have been
...
The review process is normally fairly responsive on the Rogucoin Core repository, however
...
The project leader is the release manager for each Rogucoin Core release.
