...
official/supported Docker Images found at https://hub.docker.com/r/rogucoin/rogucoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/rogucoin/rogucoind-develop/ when changing the above text**