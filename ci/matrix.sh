...
export BUILDER_IMAGE_NAME="rogucoin-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_ROGUCOIN_DEBUG"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  export RUN_INTEGRATIONTESTS=true
