# Contents
This directory contains tools to automatically get data about the memory consumption by some objects in rogucoind process with the help of GDB debugger.

## rogucoin_dbg.sh
This shell script attaches GDB to the running rogucoind process (should be built with debug info), executes debug.gdb script and detaches.
By default it uses testnet settings, see script comments to attach it to mainnet rogucoind.
