...
"""Verify that starting rogucoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rogucoind with -h for help text")
        ...
        self.log.info("Start rogucoind with -version for version information")
