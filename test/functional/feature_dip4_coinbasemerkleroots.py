...
class LLMQCoinbaseCommitmentsTest(RogucoinTestFramework):
    def set_test_params(self):
        self.set_rogucoin_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as RogucoinTestFramework doesn't support this atm)
