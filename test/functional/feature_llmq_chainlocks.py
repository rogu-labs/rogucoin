...
from test_framework.test_framework import RogucoinTestFramework
...
class LLMQChainLocksTest(RogucoinTestFramework):
    def set_test_params(self):
        self.set_rogucoin_test_params(6, 5, fast_dip3_enforcement=True)
