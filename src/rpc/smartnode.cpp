...
void smartnode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the smartnode owner Rogucoin address\n"
            "  payee          - Print the smartnode payout Rogucoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the smartnode operator public key\n"
            "  status         - Print smartnode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the smartnode voting Rogucoin address\n"
        );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "rogucoin",               "smartnode",             &smartnode,             {} },
    { "rogucoin",               "smartnodelist",         &smartnodelist,         {} },
};
