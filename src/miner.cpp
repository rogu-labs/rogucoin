...
void static RogucoinMiner(const CChainParams& chainparams)
{
    LogPrintf("RogucoinMiner -- started\n");
    return;
}

int GenerateRogucoins(bool fGenerate, int nThreads, const CChainParams& chainparams)
{
