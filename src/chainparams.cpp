...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04750822a766a47fabda52ee71a647e2713a973c99fb4664fb40800a2207e6d1721082f10bd9806bb585702fdea057c1b4b4a35b63d6b97410d572216e019bba6e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Rogucoin: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Rogucoin: 2 minutes
        ...
        consensus.smartnodePaymentFixedBlock = 4500;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V17].nStartTime = 1711088294; // 1665644400; // 0ct 13, 2022 00:00:00hrs
        ...
        consensus.defaultAssumeValid = uint256S("0x0001d86800c2b7bcf87768d8776b4b6cb4901e574b1e4e00e2556407290fdc1a7"); // 0
        ...
        genesis = CreateGenesisBlock(1711088294, 561, 0x20001fff, 3, 60 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9619bec3ddbf1dd75b5e7120da0260815218d516cd948b2df66f1b36212d6deb"));
        assert(genesis.hashMerkleRoot == uint256S("0xe090705b29bb022979a95927e0ec33e49b56e6de5e6ed4186a20dc92ad0b3fd2"));

        vSeeds.emplace_back("dnsseed.rogucoin.com");



        // Rogucoin addresses start with 'R'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,61);
        // Rogucoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Rogucoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Rogucoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Rogucoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Rogucoin BIP44 coin type is '5'
...
//        }
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 240);
        ...
        vSporkAddresses = {"RcjnUEZoKNtS9R42NGbJP4YeftVPgoMRts"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
            {
                { 0, uint256S("0x0001d86800c2b7bcf87768d8776b4b6cb4901e574b1e4e00e2556407290fdc1a7")},
                         
            }
        };

        chainTxData = ChainTxData{
            1711088294,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Rogucoin: 1 day
        consensus.nPowTargetSpacing = 60; // Rogucoin: 1 minutes
        ...
        vSeeds.emplace_back("test.rogucoin.com");
        //vSeeds.emplace_back("tnet1.rogucoin.com", true);
        //vSeeds.emplace_back("tnet2.rogucoin.com", true);

        // Testnet Rogucoin addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Rogucoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Rogucoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Rogucoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Rogucoin BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "trhjACzPtVAN2wydgDbn9Jq1agREu6rH1e");
        ...
        vSporkAddresses = {"Tgjkd8bSveaBgYFV59QdvQ2KXc2nFPcTS7"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Rogucoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Rogucoin: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("rogucoinevo.org",  "devnet-seed.rogucoinevo.org"));

        // Testnet Rogucoin addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Rogucoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Rogucoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Rogucoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Rogucoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Rogucoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
