...
#ifndef ROGUCOIN_ARITH_UINT256_H
#define ROGUCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Rogucoin only uses this "compact" format for encoding difficulty
...
#endif // ROGUCOIN_ARITH_UINT256_H
