...
//! Interface for the src/evo part of a rogucoin node (rogucoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a rogucoin node (rogucoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a rogucoin node (rogucoind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a rogucoin node (rogucoind process).
class Node
{
public:
    virtual ~Node() {}
