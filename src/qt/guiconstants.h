...
/* RogucoinGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* RogucoinGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Rogucoin"
#define QAPP_ORG_DOMAIN "rogucoin.com"
#define QAPP_APP_NAME_DEFAULT "Rogucoin-Qt"
#define QAPP_APP_NAME_TESTNET "Rogucoin-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Rogucoin-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Rogucoin-Qt-regtest"
