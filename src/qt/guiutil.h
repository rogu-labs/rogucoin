...
/** Utility functions used by the Rogucoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "rogucoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load rogucoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a rogucoin specific theme is activated (light/dark).*/
