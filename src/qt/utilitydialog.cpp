    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  rogucoin-qt [command-line options]                     \n";
...
All the Rogucoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 ROGU, 0.01 ROGU, 0.1 ROGU, 1 ROGU and 10 ROGU -- sort of like the paper money you use every day.</li> \
