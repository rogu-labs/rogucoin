Rogucoin Core version 0.12.3.2
==========================
...
See detailed [change log](https://github.com/rogu-labs/rogucoin.compare/v0.12.3.1...rogucoin:v0.12.3.2) below.

### Network:
- [`2474d9cb8`](https://github.com/rogu-labs/rogucoin.commit/2474d9cb8) Sync mn list and mnw list from 3 peers max (#2169)
- [`2c303cdb1`](https://github.com/rogu-labs/rogucoin.commit/2c303cdb1) A few devnet related fixes (#2168)

### Mining:
- [`2ba0c7760`](https://github.com/rogu-labs/rogucoin.commit/2ba0c7760) Add tests for special rules for slow blocks on devnet/testnet (#2176)
- [`b9a83d2ae`](https://github.com/rogu-labs/rogucoin.commit/b9a83d2ae) Allow mining min diff for very slow (2h+) blocks (#2175)
- [`050cabdf5`](https://github.com/rogu-labs/rogucoin.commit/050cabdf5) Adjust diff for slow testnet/devnet blocks a bit smoother (#2161)

### GUI:
- [`7b9919d18`](https://github.com/rogu-labs/rogucoin.commit/7b9919d18) Fix issues with selections on Smartnode tab (#2170)
- [`c4698d5f3`](https://github.com/rogu-labs/rogucoin.commit/c4698d5f3) Make PS Buttons not react to spacebar (#2154)

### Other:
- [`f833e2ed6`](https://github.com/rogu-labs/rogucoin.commit/f833e2ed6) Bump to 0.12.3.2 (#2173)
