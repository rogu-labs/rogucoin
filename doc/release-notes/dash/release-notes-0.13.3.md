Rogucoin Core version 0.13.3.0
==========================
...
from anti virus software. Linux builds are not affected. The mining code found in `rogucoin-qt` and `rogucoind` are only meant
...
See detailed [set of changes](https://github.com/rogu-labs/rogucoin.compare/v0.13.2.0...rogucoin:v0.13.3.0).

### Backports

- [`575cafc01`](https://github.com/rogu-labs/rogucoin.commit/575cafc01) Do not skip pushing of vMatch and vHashes in CMerkleBlock (#2826)
- [`8c58799d8`](https://github.com/rogu-labs/rogucoin.commit/8c58799d8) There can be no two votes which differ by the outcome only (#2819)
- [`66c2f3953`](https://github.com/rogu-labs/rogucoin.commit/66c2f3953) Fix vote ratecheck (#2813)
- [`b52d0ad19`](https://github.com/rogu-labs/rogucoin.commit/b52d0ad19) Fix revoke reason check for ProUpRevTx (#2787)
- [`35914e084`](https://github.com/rogu-labs/rogucoin.commit/35914e084) Skip mempool.dat when wallet is starting in "zap" mode (#2782)
- [`46d875100`](https://github.com/rogu-labs/rogucoin.commit/46d875100) Disable in-wallet miner for win/macos Travis/Gitian builds (#2778)

### Other

- [`25038ff36`](https://github.com/rogu-labs/rogucoin.commit/25038ff36) Bump version to 0.13.3.0
- [`53b2162e2`](https://github.com/rogu-labs/rogucoin.commit/53b2162e2) Harden spork15 value to 1047200 when on mainnet (#2830)
