...
This mechanism has been integrated into Bitcore-Node-Rogucoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rogu-labs/insight-api-rogucoin#web-socket-api](https://github.com/rogu-labs/insight-api-rogucoin#web-socket-api)
* API: [https://github.com/rogu-labs/insight-api-rogucoin#instantsend-transactions](https://github.com/rogu-labs/insight-api-rogucoin#instantsend-transactions)
