...
This document provides guidelines for internationalization of the Rogucoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rogucoin_en.ts` remains unchanged.
