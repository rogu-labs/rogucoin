...
rm -f src/config/rogucoin-config.h
...
rm -rf test_bitcoin.coverage/ rogucoin-gtest.coverage/ total.coverage/
...
clean_exe src/rogucoin-cli
clean_exe src/rogucoind
clean_exe src/rogucoin-gtest
clean_exe src/rogucoin-tx
clean_exe src/test/test_rogucoin
clean_exe src/test/test_rogucoin_fuzzy
...
clean_dep . src/config/rogucoin-config.h.in
